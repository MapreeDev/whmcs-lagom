                ...
                <div class="app-main__content">
                    <div class="tabs__body">
                        <div class="tab-content">
                            {* Tab CMS *}
                            {if \RSThemes\Helpers\ContentChecker::checkCmsInstalled() && $isLagom2}
                                {include file="adminarea/cms/cms_settings_tab.tpl"}
                            {/if}

                            {* Tab General Settings *}
                            <div class="tab-pane {if $smarty.get.settingsTab == 'settings-general' || ((!\RSThemes\Helpers\ContentChecker::checkCmsInstalled() || !$isLagom2) && !isset($smarty.get.settingsTab))} is-active {/if}" id="settings-general">
