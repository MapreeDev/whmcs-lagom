...
<div class="tab-content">
    <div class="tab-pane is-active" id="{$type}-lagom-small" data-media-container>
        ...
        <div class="media">
           <div class="media__list" data-media-list data-media-insert="lagomsmall">
    ...
    <div class="tab-pane" id="{$type}-lagom-medium" data-media-container> 
        ...
        <div class="media">
            <div class="media__list" data-media-list data-media-insert="lagommedium">
    ...
    <div class="tab-pane" id="{$type}-font-awesome" data-media-container>
        ...
        <div class="media">
            <div class="media__list" data-media-list data-media-insert="fontawesome">
