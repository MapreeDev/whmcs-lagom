...
{else}
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <label for="inputFirstName" class="control-label {if !in_array('firstname', $clientsProfileOptionalFields)} label-required{/if}">
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                <label for="inputLastName" class="control-label {if !in_array('lastname', $clientsProfileOptionalFields)} label-required{/if}">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="inputPhone" class="control-label {if !in_array('phonenumber', $clientsProfileOptionalFields)} label-required{/if}">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="inputAddress1" class="control-label {if !in_array('address1', $clientsProfileOptionalFields)} label-required{/if}">
                    {$LANG.orderForm.streetAddress} {if in_array('address1', $clientsProfileOptionalFields)} ({$LANG.orderForm.optional}){/if} 
                </label>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="inputCity" class="control-label {if !in_array('city', $clientsProfileOptionalFields)} label-required{/if} ">
                    {$LANG.orderForm.city} {if in_array('city', $clientsProfileOptionalFields)} ({$LANG.orderForm.optional}){/if} 
                </label> 
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="inputState" class="control-label {if !in_array('state', $clientsProfileOptionalFields)} label-required{/if}">
                            {$LANG.orderForm.state} {if in_array('state', $clientsProfileOptionalFields)} ({$LANG.orderForm.optional}){/if}
                        </label>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="inputPostcode" class="control-label {if !in_array('postcode', $clientsProfileOptionalFields)} label-required{/if}">
                            {$LANG.orderForm.postcode}{if in_array('postcode', $clientsProfileOptionalFields)} ({$LANG.orderForm.optional}){/if}
                        </label>
