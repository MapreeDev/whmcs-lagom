                        ...
                        <div class="col{if $RSThemes['pages'][$templatefile]['config']['horizontalPackage'] == 1} col-12{/if}">
                            <div class="package{if $product.isFeatured} package-featured{/if}{if $RSThemes['pages'][$templatefile]['config']['horizontalPackage'] == 1} package-horizontal{/if}" id="{$idPrefix}">
                                ...
                                <div class="package-footer package-side package-side-right">
                                    ...
                                    {if $product_restock_notifierAddonIsActive}
                                        ...
                                        {else}
                                            <a href="{$product.productUrl}" class="btn btn-lg btn-primary btn-order-now {if $RSThemes['pages']['products']['config']['productColumns'] == '4' && $RSThemes['pages']['products']['config']['hideSidebar'] == '0'} no-min-width{/if} {if $product.stockControlEnabled && $product.qty == '0'}disabled{/if}" id="{$idPrefix}-order-button" {if $product.hasRecommendations} data-has-recommendations="1"{/if}>
                                                {$LANG.ordernowbutton}
                                            </a>
                                        {/if}
                                    {else}
