$(document).ready(function(){
    ...
    $(document).ready(function () {
        $('.switch__checkbox--domain').on('change', function(e){
            var input = $(this);
            var domainUrl = input.data('action');
            var renewData = {
                id: input.data('domainid'),
                sub: input.data('domainsub'),
                autorenew: input.data('domainautorenew'),
                token: input.data('token'),
            };

            if(input.data('domainautorenew') == 'disable'){
                input.attr('domain-autorenew', 'enable');
            }else{
                input.attr('domain-autorenew', 'disable');
            }
    ...
    jQuery(document).on('click', '[data-service-id]', function (event) {
        var element = jQuery(event.target);
