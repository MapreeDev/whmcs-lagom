<svg class="svg-icon {if $onDark} svg-icon-on-dark {/if}" xmlns="http://www.w3.org/2000/svg" width="64" height="65" fill="none" viewBox="0 0 64 65">
    ...
    <path fill="var(--svg-icon-color-2)" fill-rule="evenodd" d="M17.0162 33.8613V39.4769L14.0195 41.1709V35.5502L17.0162 33.8613Z" clip-rule="evenodd" />
    <path fill="var(--svg-icon-color-2)" fill-rule="evenodd" d="M22.0162 28.8613V36.6054L19.0195 38.2787V30.5885L22.0162 28.8613Z" clip-rule="evenodd" />
    <path fill="var(--svg-icon-color-2)" fill-rule="evenodd" d="M27.0156 23.5146V33.6512L24.0078 35.4072V25.2728L27.0156 23.5146Z" clip-rule="evenodd" />
    <path fill="var(--svg-icon-color-2)" fill-rule="evenodd" d="M32.0156 18.8613V30.8613L29.0156 32.5315V20.6296L32.0156 18.8613Z" clip-rule="evenodd" />
</svg>