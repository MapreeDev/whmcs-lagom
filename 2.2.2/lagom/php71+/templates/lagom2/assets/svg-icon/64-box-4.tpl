<svg class="svg-icon {if $onDark} svg-icon-on-dark {/if}" xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="none" viewBox="0 0 64 64">
    <path stroke="var(--svg-icon-color-3)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M32 1L59 16.59V47.41M32 1V31.82M32 1L5 16.59V47.41M32 31.82L59 47.41M32 31.82L5 47.41M59 47.41L32 63L5 47.41" />
