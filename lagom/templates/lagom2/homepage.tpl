                    ...
                    <div class="domain-search-input search-group search-group-combined">
                        ...
                        <div class="search-group-btn">
                            {if $transferdomainenabled}
                                <input type="submit" name="transfer" class="btn btn-lg btn-primary-faded transfer {$captcha->getButtonClass($captchaForm)}" value="{$LANG.domainstransfer}" />
                            {/if}
                            {if $registerdomainenabled}
                                <input type="submit" class="btn btn-lg btn-primary search {$captcha->getButtonClass($captchaForm)}" value="{$LANG.search}" id="btnDomainSearch"/>
                            {/if}
                        </div>
                    </div>
