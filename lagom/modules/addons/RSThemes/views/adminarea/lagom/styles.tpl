...
{block name="template-content"}
     <div class="section">
        <div class="t-c mob-t-c--full" data-table-container data-table-check-container>
            <div class="t-c__top top m-b-4x" data-top-search data-toggler-options="toggleClass: is-open;">
                <div class="top__toolbar">
                    <h3 class="section__title">Styles</h3>
                </div>
        ...
        <div class="t-c__body t-c__body--boxed">
            <table class="t-c__table table mob-table--block" id="styles-table" data-services-table data-search-input="#table-search" data-clickable-rows="true" data-responsive="false">
                <colgroup>
                            ...
                            <tr>
                                ...
                                <td class="cell-scheme">
                                    <div class="scheme-colors">
                                        <div class="scheme-color" style="background: {$style->color()->getDisplayColors(0)}"></div>
                                        <div class="scheme-color" style="background: {$style->color()->getDisplayColors(1)}"></div>
                                    </div>
                                </td>
                                {/if}
                                <td class="cell-status">
                                    <div class="status">
                                        {if $style->isActiveFromConfig()}<span class="label label--outline label--success">Active</span>{else}<span class="label label--outline label--default">Disabled</span>{/if}
                                    </div>
                                </td>
                                        ...
                                        <div class="dropdown" data-dropdown-menu>
                                            ...
                                            <div class="dropdown__menu">
                                                <ul class="nav">
                                                    ...
                                                    {if $template->getVersion()|intval >= 2}
                                                    <li class="nav__item">
                                                        <a class="nav__link" href="{$helper->url('Template@manageStyle',['templateName'=>$template->getMainName(), 'styleName' => $style->getName()])}">
                                                    ...
                                                    {if !$style->isActiveFromConfig()}
                                                        ...
                                                        <li class="nav__item">
                                                            <a class="nav__link" href="{$helper->url('Template@setStyle',['templateName'=>$template->getMainName(), 'styleName' => $style->getMainName()])}" data-toggle="lu-notification" data-status="success" data-timeout="5000" data-title="Success" data-body="Changes has been sucesfully saved!">
