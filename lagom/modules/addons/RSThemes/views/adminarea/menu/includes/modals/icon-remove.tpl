    ...
    <div class="modal__dialog">
        <div class="modal__content">
            <div class="modal__top top">
                <div class="top__title text-danger"><i class="ls ls-exclamation-circle m-r-2x"></i>Remove Icon</div>
            ...
            <div class="modal__actions">
                <a class="btn btn--danger" data-delete-icon-modal-submit data-graphic-name="" data-section="">
