<ul class="nav nav--tabs custom-nav-styles" data-form-tabs="settings_tab">
    ...
    {/if}
    <li class="nav__item {if $smarty.get.settingsTab == 'settings-general' || ((!\RSThemes\Helpers\ContentChecker::checkCmsInstalled() || !$isLagom2) && !isset($smarty.get.settingsTab))} is-active {/if}">
        <a class="nav__link" data-toggle="lu-tab" data-change-hash="true"
